...
* [Avoid placeholders](#avoid-placeholders)
* [Examples](#examples)
...
In the above section, placeholders were used for identifiers. They can also safely be used for things like names, or titles, etc. However, avoid placeholders the placeholder is known at compile time and especially if the placeholder can be different nouns or different verbs.
...
If there are pre-defined and custom types handle them separately:
