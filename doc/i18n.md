...
(This batch job is not automated at this time; contact Peter Murray ([FOLIO Slack](slack://user?team=T1EPYQDAQ&id=U1T4P0GPQ), [email](peter@indexdata.com)) to request a Lokalise-to-GitHub merge for a particular git repository.)
