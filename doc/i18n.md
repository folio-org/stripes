...
(If the Jenkins test for any module fails, _all_ pull requests for that batch job run are deleted.  This ensures a consistent state between the Lokalise database and the GitHub repositories.)
