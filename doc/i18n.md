...
Don't split them into 4 translation chunks:
...
Use complete sentences as shown in the correct example above.
...
Avoid placeholders if all or a fraction of the possible values is known at development time.
